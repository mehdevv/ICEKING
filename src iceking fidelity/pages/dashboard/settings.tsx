...
export default function Settings() {
  ...
  const [general, setGeneral] = useState({ businessName: "", logoUrl: "", currency: "DZD", timezone: "Africa/Algiers", primaryColor: "#1A56DB", secondaryColor: "#0E9F6E" });
  ...
  useEffect(() => {
    if (settings) {
      setGeneral({ businessName: settings.businessName ?? "", logoUrl: settings.logoUrl ?? "", currency: settings.currency ?? "DZD", timezone: settings.timezone ?? "Africa/Algiers", primaryColor: settings.primaryColor ?? "#1A56DB", secondaryColor: settings.secondaryColor ?? "#0E9F6E" });
        ...
        <TabsContent value="general" className="mt-4">
          <Card>
            ...
            <CardContent className="space-y-5">
              ...
              <div><Label>Logo URL</Label><Input className="mt-1" value={general.logoUrl} onChange={e => setGeneral(g => ({ ...g, logoUrl: e.target.value }))} placeholder="https://…" /></div>
